...
@Entity
@Table(name = "VF_TASK_CONF_COLUMN_HEADER")
public class TaskConfColumnHeader {
	...
	public TaskConfColumnHeader(String columnId, String formId, String fieldName, String accessor,
