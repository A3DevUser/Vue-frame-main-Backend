...
@Entity
@Table(name = "VF_VRM_OUTPUT_ASSESS_DDQ")
public class VfVrmOutputAssessDdq {
	...
	public VfVrmOutputAssessDdq(String ddqId, String reviewId, String vendorId, String associateVendor, String status,
