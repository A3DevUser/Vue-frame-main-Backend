...
@Entity
@Table(name = "VF_VRM_OUTPUT_ASSESS_TPRE")
public class VfVrmOutputAssessTpre {
	
	@Id
	@Column(name = "TPRE_ID")
	private String tpreId;
	...
	public VfVrmOutputAssessTpre(String tpreId, String reviewId, String vendorId, String associateVendor, String status,
